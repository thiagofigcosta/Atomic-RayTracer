...
public class Main {
    ...
    private static final int RAYSPERPIXEL = 1;
    private static final int RAYSINTERACTIONS = 1;
    ...
    public static void main(String[] args) {
        ...
        Vector3[][] pixels = tracer.renderScene(scene, HEIGHT, WIDTH,RAYSPERPIXEL,RAYSINTERACTIONS);
