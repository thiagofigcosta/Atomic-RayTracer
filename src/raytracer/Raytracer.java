...
public class Raytracer {
     ...
     */
    public Vector3[][] renderScene(Scene scene, int height, int width, int raysPerPixel, int rayInteractions) {
        ...
        for (int i = 0; i < height; i++) {
            for (int j = 0; j < width; j++) {
                ...
                Vector3 color = castRay(scene, ray,raysPerPixel,rayInteractions);
